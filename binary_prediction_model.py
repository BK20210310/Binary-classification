...
train_X2 = df_array[train_list, 0:2]
valid_X2 = df_array[val_list, 0:2]

model_glm = linear_model.LogisticRegression(penalty='none')
model_glm.fit(train_X2, train_Y)
train_glm = model_glm.predict_proba(train_X2)[:,1]
val_glm = model_glm.predict_proba(valid_X2)[:,1]
...
ROC_curve("s100a8", train_s100a8, val_s100a8, "lightblue", "t")
ROC_curve("s100a9", train_s100a9, val_s100a9, "darkgray", "t")
ROC_curve("glm", train_glm, val_glm, "navy", "t")
plt.plot([0, 1], [0, 1], color='black', linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.0])
plt.xlabel('1 - Specificity')
...
plt.title('ROC curve of training data')
plt.legend(loc="lower right")
plt.savefig("glm_training.png", dpi = 300)
plt.show()
...
ROC_curve("s100a8", train_s100a8, val_s100a8, "lightblue", "v")
ROC_curve("s100a9", train_s100a9, val_s100a9, "darkgray", "v")
ROC_curve("glm", train_glm, val_glm, "navy", "v")
plt.plot([0, 1], [0, 1], color='black', linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.0])
plt.xlabel('1 - Specificity')
...
plt.title('ROC curve of validation data')
plt.legend(loc="lower right")
plt.savefig("glm_validation.png", dpi = 300)
plt.show()
...
ROC_curve("s100a8", train_s100a8, val_s100a8, "lightblue", "t")
ROC_curve("s100a9", train_s100a9, val_s100a9, "darkgray", "t")
ROC_curve("il6", train_il6, val_il6, "pink", "t")
ROC_curve("tnfa", train_tnfa, val_tnfa, "thistle", "t")
plt.plot([0, 1], [0, 1], color='black', linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.0])
plt.xlabel('1 - Specificity')
...
plt.title('ROC curve of training data')
plt.legend(loc="lower right")
plt.savefig("single marker_training.png", dpi = 300)
plt.show()
...
ROC_curve("s100a8", train_s100a8, val_s100a8, "lightblue", "v")
ROC_curve("s100a9", train_s100a9, val_s100a9, "darkgray", "v")
ROC_curve("il6", train_il6, val_il6, "pink", "v")
ROC_curve("tnfa", train_tnfa, val_tnfa, "thistle", "v")
plt.plot([0, 1], [0, 1], color='black', linestyle='--')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.0])
plt.xlabel('1 - Specificity')
...
plt.title('ROC curve of validation data')
plt.legend(loc="lower right")
plt.savefig("single marker_validation.png", dpi = 300)
plt.show()